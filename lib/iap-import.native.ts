...
export const requestSubscription = (args: any) =>
  _requestPurchase({ ...args, type: 'subs' });

// requestPurchase — for consumable in-app purchases (pass-through, type defaults to 'in-app')
export const requestPurchase = (args: any) =>
  _requestPurchase({ ...args, type: 'in-app' });
...
export type { Subscription, Product, Purchase, PurchaseError };